...
INSERT INTO products (name, description, image_path, is_weekly_special, price_cents) VALUES
...
CREATE INDEX idx_products_weekly_special ON products(is_weekly_special);
